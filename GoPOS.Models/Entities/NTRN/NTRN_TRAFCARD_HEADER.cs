...
[Table("NTRN_TRAFCARD_HEADER")]
public class NTRN_TRAFCARD_HEADER : IIdentifyEntity
{
	/// <summary>
	/// 매장코드
	/// </summary>
	...
	/// <summary>
	/// 선불카드 충전 승인형태 0:본사승인 1:매장승인
	/// </summary>
	[Comment("선불카드 충전 승인형태 0:본사승인 1:매장승인")]
	public string? APPR_SHOP_FLAG { get; set; }
	/// <summary>
	/// 총판매금액
	/// </summary>
	[Comment("총판매금액")]
	...
	{
		return "SHOP_CODE_SALE_DATE_POS_NO_SALE_NO_REGI_SEQ";
	}

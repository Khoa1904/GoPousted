...
namespace GoPOS.Models
{
    ...
    /// [매장]제휴카드-정보
    /// </summary>
    public class SHOP_ALLIANCE_TARGET_PRODUCT_GetSATPList
    {

        /// <summary>
        /// SHOP_ALLIANCE_TARGET_PRODUCT_GetSATPList

        /// </summary>
        public SHOP_ALLIANCE_TARGET_PRODUCT_GetSATPList()
        {
            /*
        ...
        public SHOP_ALLIANCE_TARGET_PRODUCT_GetSATPList(string shop_code, string jcd_code)
        {

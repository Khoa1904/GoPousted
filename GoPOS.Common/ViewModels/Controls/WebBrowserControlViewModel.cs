...
{
    public class WebBrowserControlViewModel : BaseItemViewModel
    {
        ...
        public WebBrowserControlViewModel(IWindowManager windowManager, IEventAggregator eventAggregator,
